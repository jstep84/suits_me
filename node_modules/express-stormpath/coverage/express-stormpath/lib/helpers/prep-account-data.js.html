...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/helpers/prep-account-data.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/helpers/</a> prep-account-data.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  Object.keys(formData).forEach(function (key) {
    ...
    if (coreFields.indexOf(key) &gt; -1) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (accountObject.customData) {
        Object.keys(value).reduce(function (customData, field) {
          customData[field] = value[field];
          return customData;
        }, accountObject.customData);
      } else {
<span class="cstat-no" title="statement not covered" >        accountObject.customData = value;</span>
      }
