...
<html lang="en">
<head>
    <title>Code coverage report for express-stormpath/lib/middleware/login-required.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/middleware/</a> login-required.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (req.accepts(['html', 'json']) === 'html') {
    var url = config.web.login.uri + '?next=' + encodeURIComponent(req.originalUrl);
    return res.redirect(302, url);
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  res.status(401).end();</span>
};
&nbsp;</pre></td></tr>
</table></pre>
