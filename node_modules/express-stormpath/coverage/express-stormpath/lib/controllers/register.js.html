...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/controllers/</a> register.js
    </h1>
    <div class='clearfix'>
          ...
          case 'POST':
            async.waterfall([
              ...
              function (callback) {
                handlePreRegistration(req.body, function (err) {
                  <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >                    return writeFormError(err);</span>
                  }
&nbsp;
                  helpers.validateAccount(req.body, config, function (errors) {
                    if (errors) {
