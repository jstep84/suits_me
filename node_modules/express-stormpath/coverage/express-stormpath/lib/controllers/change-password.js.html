...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">express-stormpath/lib/controllers/</a> change-password.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  helpers.handleAcceptRequest(req, res, {
    'application/json': function () {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method !== 'GET' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >req.method !== 'POST')</span> {
...
<span class="cstat-no" title="statement not covered" >          res.end();</span>
    ...
    'text/html': function () {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (req.method !== 'GET' &amp;&amp; req.method !== 'POST') {
<span class="cstat-no" title="statement not covered" >        return next();</span>
      }
&nbsp;
      application.verifyPasswordResetToken(sptoken, function (err, result) {
